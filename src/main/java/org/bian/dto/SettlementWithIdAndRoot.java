 ...
 */
public class SettlementWithIdAndRoot   {
  private String merchantAcquiringSettlementTaskReference = null;
   ...
   * @return merchantAcquiringSettlementTaskReference
  **/

  public String getMerchantAcquiringSettlementTaskReference() {
    return merchantAcquiringSettlementTaskReference;
  }

  public void setMerchantAcquiringSettlementTaskReference(String merchantAcquiringSettlementTaskReference) {
    this.merchantAcquiringSettlementTaskReference = merchantAcquiringSettlementTaskReference;
  }
